...
langevin1 = LangevinStateSpace(initial_state, theta, ngp1, observation_matrix1, truncation_level=1e-6, rng=rng1, modelCase=2)
...
langevin2 = LangevinStateSpace(initial_state, theta, ngp2, observation_matrix2, truncation_level=1e-6, rng=rng2, modelCase=2)
